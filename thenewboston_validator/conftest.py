...
from thenewboston_validator.self_configurations.management.commands.initialize_test_confirmation_validator import (
    FIXTURES_DIR as CONFIRMATION_VALIDATOR_FIXTURES_DIR
)
from thenewboston_validator.self_configurations.management.commands.initialize_test_primary_validator import (
    FIXTURES_DIR as PRIMARY_VALIDATOR_FIXTURES_DIR
)
from thenewboston_validator.validators.factories.validator import ValidatorFactory
