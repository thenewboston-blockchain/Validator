...
FIXTURES_DIR = os.path.join(CURRENT_DIR, 'primary_validator_fixtures')

User = get_user_model()


class Command(BaseCommand):
    help = 'Delete existing data, load in fixture data, set self as primary validator, rebuild cache'  # noqa: A003
