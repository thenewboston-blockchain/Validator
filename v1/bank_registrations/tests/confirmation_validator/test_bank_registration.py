...
class TestBankRegistration(TestConfirmationValidator):

    def test_create_bank_registration_with_confirmation_validator(self):
        """
        Validate creation of bank registration with confirmation validator
        """

        Bank.objects.all().delete()
        BankRegistration.objects.all().delete()
        ...
        self.validate_post('/bank_registrations', payload, status.HTTP_201_CREATED)
